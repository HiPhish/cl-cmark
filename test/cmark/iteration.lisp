...
(test complex-tree
  ...
  (let* ((a (make-instance 'cmark:document-node))
         (b (make-instance 'cmark:block-quote-node))
         (c (make-instance 'cmark:block-quote-node))
         (d (make-instance 'cmark:block-quote-node))
         (e (make-instance 'cmark:block-quote-node))
         (f (make-instance 'cmark:block-quote-node))
         (g (make-instance 'cmark:block-quote-node))
         (h (make-instance 'cmark:block-quote-node))
         (i (make-instance 'cmark:block-quote-node))
         (j (make-instance 'cmark:block-quote-node))
         (k (make-instance 'cmark:block-quote-node))
         (l (make-instance 'cmark:block-quote-node))
